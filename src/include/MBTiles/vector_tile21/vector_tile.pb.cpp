...
constexpr Tile_Value::Tile_Value(
...
struct Tile_ValueDefaultTypeInternal {
  constexpr Tile_ValueDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT Tile_ValueDefaultTypeInternal _Tile_Value_default_instance_;
constexpr Tile_Feature::Tile_Feature(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : tags_()
...
struct Tile_FeatureDefaultTypeInternal {
  constexpr Tile_FeatureDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT Tile_FeatureDefaultTypeInternal _Tile_Feature_default_instance_;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_vector_5ftile_2eproto = {
  false, false, 611, descriptor_table_protodef_vector_5ftile_2eproto, "vector_tile.proto",
  ...
  file_level_metadata_vector_5ftile_2eproto, file_level_enum_descriptors_vector_5ftile_2eproto, file_level_service_descriptors_vector_5ftile_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_vector_5ftile_2eproto_getter() {
  return &descriptor_table_vector_5ftile_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_vector_5ftile_2eproto(&descriptor_table_vector_5ftile_2eproto);
namespace vector_tile {
...
void Tile_Value::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<Tile_Value *>(to)->MergeFrom(
      static_cast<const Tile_Value &>(from));
}
...
void Tile_Feature::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<Tile_Feature *>(to)->MergeFrom(
      static_cast<const Tile_Feature &>(from));
}
